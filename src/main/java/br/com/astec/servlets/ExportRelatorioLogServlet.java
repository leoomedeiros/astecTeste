 ...
 * @author Usuário
 */
@WebServlet(name = "ExportRelatorioLogServlet", urlPatterns = {"/ExportRelatorioLogServlet"})
public class ExportRelatorioLogServlet extends HttpServlet {
        ...
        if ((!dataInicial.isEmpty())&&(!dataFinal.isEmpty())){
            try {
                ...
                String dataFormatada = formato.format(data);
                 ...
                 response.setHeader("Content-disposition","attachment; filename=Relatorio_Log_"+dataFormatada+".csv");

                 // Assume file name is retrieved from database
                 // For example D:\\file\\test.pdf

                 File arquivo = GeradorRelatorio.generateLogCsvFile(lista, "Relatorio_Log");
