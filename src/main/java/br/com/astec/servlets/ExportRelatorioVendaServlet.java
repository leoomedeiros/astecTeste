 ...
 * @author Usuário
 */
@WebServlet(name = "ExportRelatorioVendaServlet", urlPatterns = {"/ExportRelatorioVendaServlet"})
public class ExportRelatorioVendaServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        double valorTotalRelatorio = Double.parseDouble
        (session.getAttribute("valorTotalRelatorio").toString());
        ...
        if ((!dataInicial.isEmpty()) && (!dataFinal.isEmpty())) {
            try {
                ...
                lista = vDao.consultaVendaPorDatas(dataInicial, dataFinal);
                ...
                File arquivo = GeradorRelatorio.generateVendaCsvFile(lista, "Relatorio_Venda",valorTotalRelatorio);
