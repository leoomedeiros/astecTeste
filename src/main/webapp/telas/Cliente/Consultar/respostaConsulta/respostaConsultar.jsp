        ...
        <div id="subRelatorio" class="sub">
            <ul class="submenu">
                ...
                <li id="relVenda" type="hidden">
                    <a href="../../../Relatorio/relatorioProduto_falta/relatorioProduto.jsp">Relatório de Venda</a>
                </li>
                <li id="relLog" type="hidden">
                    <a href="../../../Relatorio/relatorioProduto_falta/relatorioProduto.jsp">Relatório de Log</a>
                </li>
            </ul>
        </div>
