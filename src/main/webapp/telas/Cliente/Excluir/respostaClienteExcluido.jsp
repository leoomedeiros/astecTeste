...
<html>
    <head>
        ...
        <link href="excluirCliente.css" type="text/css" rel="stylesheet">
        <script src="excluirCliente.js" type="text/javascript" rel="javascript"></script>
    </head>
    <body>
        <div id="direito">
            <div id="cabecalho">
            ...
            <div id="conteudo">
                ...
                <h2>Cliente "<c:out value="${sessionScope.clienteConsultado.nome}" />"  foi excluído com sucesso.</h2>
