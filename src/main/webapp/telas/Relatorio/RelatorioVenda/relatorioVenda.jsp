<%-- 
    ...
    Created on : 23/11/2017, 19:45:56
    Author     : Usuário
--%>
...
<html>
    <head>
        ...
        <link href="relatorioVenda.css" rel="stylesheet">
        <script src="relatorioVenda.js" type="text/javascript"></script>
    </head>
    <body>
        <div id="direito">
            <div id="cabecalho">
            ...
            <div id="conteudo">
                <form class="pesquisa" action="${pageContext.request.contextPath}/RelatorioVendaServlet" method="POST">  
                ...
                <div class="divTabela">
                        <table>
                                ...
                                <c:forEach items="${sessionScope.listaVenda}" var="listaVenda" >
                                <tr class="linhas">
                                    <td>${listaVenda.id}</td>
                                    <td>${listaVenda.idCliente}</td>
                                    <td>${listaVenda.dataCompra}</td>
                                    <td>${listaVenda.valorTotal}</td>
                                </tr>
                                </c:forEach>
                ...
                <form class="pesquisa" action="${pageContext.request.contextPath}/ExportRelatorioLogProdutoServlet" method="POST">
                    ...
                    <h3>VALOR TOTAL DE TODAS AS VENDAS: <%=session.getAttribute("valorTotalRelatorio")%></h3>
                    <button class="botao"
                            name="Export"
        ...
        <div class="menu principal">
            ...
            <ul class="menu">
                ...
                <li type="visible">
                    <a href="../../Venda/venda.jsp">Venda</a>                    
                </li>
                <li type="visible">
                    <a>Relatórios</a>
            ...
            <div id="subRelatorio" class="sub">
                <ul class="submenu">
                        ...
                        <li id="relVenda" type="hidden">
                            <a href="relatorioVenda.jsp">Relatório de Venda</a>
                        </li>
